...
fun MetObjectDetailView(
    ...
    metObject: com.bahadori.model.MetObject,
) {
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                metObject.objectWikidataUrl?.let { url ->
                    if (url.isNotEmpty())
                        OutlinedButton(
                            ...
                            Icon(
                                ...
                                painter = painterResource(id = MetIcons.Wikipedia),
                ...
                metObject.objectURL?.let { url ->
                    if (url.isNotEmpty())
                        OutlinedButton(
                            ...
                            Icon(
                                modifier = Modifier.padding(end = 4.dp),
                                painter = painterResource(id = MetIcons.MetMuseum),
                                contentDescription = stringResource(
